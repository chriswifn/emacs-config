...
|------------+---------------------+------------------------------------------|
| SPC f f    | counsel-find-file   | Find a file in current working directory |
| SPC f z    | counsel-fzf         | fuzzy-finder                             |
| SPC f g    | counsel-grep        | grep                                     |
| SPC f r    | counsel-recentf     | Find recently opened files using recentf |
...
| SPC b b    | counsel-switch-buffer             | Pick buffer from a list of open buffers                                         |
